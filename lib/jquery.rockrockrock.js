...
$.fn.rockrockrock = function(options) {
    ...
    var playSong = function() {
            elem.trigger(settings.prefix+'.play');
            player.play();
            $(btnPlay).hide();
            $(btnPause).show();
    },
        pauseSong = function() {
            elem.trigger(settings.prefix+'.pause');
            player.pause();
            $(btnPause).hide();
            $(btnPlay).show();
    },
        nextSong = function() {
            elem.trigger(settings.prefix+'.next');
        ...
        prevSong = function() {
            elem.trigger(settings.prefix+'.prev');
        ...
        muteSong = function() {
            elem.trigger(settings.prefix+'.mute');
            btnMute.hide();
            btnUnmute.show();
        ...
        unmuteSong = function() {
            elem.trigger(settings.prefix+'.unmute');
            btnUnmute.hide();
            btnMute.show();
            player.muted=false;
